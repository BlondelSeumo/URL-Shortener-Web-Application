                        ...
                        <form method="GET" action="{{ route('links') }}" class="d-md-flex">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="btn {{ request()->input('search') || request()->input('domain') || request()->input('space') || request()->input('pixel') || request()->input('status') || request()->input('by') || request()->input('sort') ? 'btn-primary' : 'btn-outline-primary' }} d-flex align-items-center dropdown-toggle dropdown-toggle-split reset-after" data-enable="tooltip" title="{{ __('Filters') }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@include('icons.filter', ['class' => 'fill-current width-4 height-4'])&#8203;</button>
                                    <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64" id="search-filters">
                                        <div class="dropdown-header py-1">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    @if(request()->input('search') || request()->input('domain') || request()->input('space') || request()->input('pixel') || request()->input('status') || request()->input('by') || request()->input('sort'))
                ...
                <div class="list-group-item px-0 text-muted">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto d-flex">
                            <button type="button" class="btn text-primary btn-sm d-flex align-items-center invisible {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">@include('icons.copy-link', ['class' => 'fill-current width-4 height-4'])&#8203;</button>

                            <button type="button" href="#" class="btn text-primary d-inline-flex align-items-center invisible">@include('icons.horizontal-menu', ['class' => 'fill-current width-4 height-4'])</button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body">
                @can('dataExport', ['App\Link', Auth::user()->plan->features->data_export])
...
@include('shared.modals.delete-link')